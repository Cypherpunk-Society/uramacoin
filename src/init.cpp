...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/uramacoin-project/uramacoin>";
    const std::string URL_WEBSITE = "<https://uramacoin.org>";
