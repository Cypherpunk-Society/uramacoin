...
{
    const char* pszTimestamp = "urama2022";
    const CScript genesisOutputScript = CScript() << ParseHex("666666710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1669433115, 2000854394, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6b3371f5638c0fa864117a82f959d33f76b3ad826c32ae6ea332ca4a4f2c01df"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1bc830ab928259461a1ff272d676693c25ba4a8d3640923320bfd24400ccb11"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("165.227.97.148", "165.227.97.148", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("uramacointools.com", "dnsseed.uramacointools.com"));
        // vSeeds.push_back(CDNSSeedData("uramacoinpool.org", "dnsseed.uramacoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x6b3371f5638c0fa864117a82f959d33f76b3ad826c32ae6ea332ca4a4f2c01df"))
        ...
        chainTxData = ChainTxData{
            ...
            1669433115, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1669433115, 237638, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd27264cb977941d5ecb4de7860269386521ce7836900fc08b815ee139230a2c4"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1bc830ab928259461a1ff272d676693c25ba4a8d3640923320bfd24400ccb11"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("165.227.97.148", "165.227.97.148"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.uramacoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xd27264cb977941d5ecb4de7860269386521ce7836900fc08b815ee139230a2c4")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1669433115, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xccf2b677a1a3acff9d1503ab6105980a72ddbab7b185da34ac54c57b83512fe8"));
        assert(genesis.hashMerkleRoot == uint256S("0xa1bc830ab928259461a1ff272d676693c25ba4a8d3640923320bfd24400ccb11"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xccf2b677a1a3acff9d1503ab6105980a72ddbab7b185da34ac54c57b83512fe8"))
        };
