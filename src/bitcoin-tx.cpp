...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s uramacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  uramacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded uramacoin transaction") + "\n" +
              "  uramacoin-tx [options] -create [commands]   " + _("Create hex-encoded uramacoin transaction") + "\n" +
              "\n";
